...
button_projetos.addEventListener('click', ()=>{
  button_projetos.classList.toggle('ativo');
  button_habilidades.classList.remove('ativo');
  show_habilidades.style.display = 'none';
  show_projetos.style.display = 'flex';
});

button_habilidades.addEventListener('click', ()=>{
  button_habilidades.classList.toggle('ativo');
